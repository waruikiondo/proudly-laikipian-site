...
export default function JournalPage() {
  return (
    // pt-32 is crucial here to push content below the absolute header
    <div className="min-h-screen bg-[#fcfbf9] text-[#1a1a1a] pt-32">
      
      {/* 1. The Header Section */}
      <section className="pb-16 px-6 md:px-12 text-center max-w-5xl mx-auto animate-fade-in-up">
      ...
      <div className="flex justify-center gap-8 mb-16 text-xs md:text-sm font-bold tracking-[0.2em] uppercase text-gray-400">
      ...
      <section className="max-w-[1600px] mx-auto px-6 md:px-12 pb-32">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-16">
          {journalPosts.map((post) => (
            <Link href={`/journal/${post.slug}`} key={post.id} className="group block cursor-pointer">
              ...
              <div className="relative overflow-hidden w-full aspect-[4/3] mb-8 bg-gray-200">
                <Image 
                  ...
                  layout="fill"
                  objectFit="cover"
                  className="transition-transform duration-700 ease-out group-hover:scale-105 grayscale-[10%] group-hover:grayscale-0"
                />
              </div>
              ...
              <div className="flex flex-col items-start space-y-4">
                ...
                <h2 className="text-2xl font-serif leading-snug text-gray-900 group-hover:text-gray-600 transition-colors">
                  {post.title}
                </h2>
